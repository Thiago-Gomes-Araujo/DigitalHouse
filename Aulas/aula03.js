...
const darBanhoNoPet = (pet) =>{
  ...
  console.log(dataDoServico.getDate() + "/"+ (dataDoServico.getMonth() + 1)+ "/"+dataDoServico.getUTCFullYear());
}
...
const cadastrarPetsDoJsonSpredOperator = (lista, aulahj) =>{
  let arrayPets = JSON.parse(aulahj)
  lista.push(...arrayPets)
  return lista
}

const cadastrarPetsDoJsonFor = (lista, aulahj) => {
  let arrayPets = JSON.parse(aulahj)
...
//}
//}
//console.log(filtrarPetPorNome("x"))

var arr = [];
arr.push({id: 1, nome: 'Yoshi'});
